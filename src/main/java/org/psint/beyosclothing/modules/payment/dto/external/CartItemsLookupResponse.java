...
/**
 * Response DTO for cart items lookup
 * Received from Cart module via RabbitMQ
 */
@Data
@Builder
@NoArgsConstructor
...
public class CartItemsLookupResponse implements Serializable {
    ...
    private BigDecimal totalWeight; // Total weight of all selected items
    ...
    public static class CartItemInfo implements Serializable {
        ...
        private Integer availableStock; // Available stock from inventory
    }
}
